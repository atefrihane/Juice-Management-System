        ...
        methods: {
            validateForm() {
                ...
                if (this.new_status != 12) {
                    if (!this.date) {
                        this.$emit('requiredValue', 'Veuillez séléctionner une date de livraison effective  ')
                        return false;
                    }
                    if (!this.time) {
                        this.$emit('requiredValue', 'Veuillez séléctionner une heure de livraison effective  ')
                        return false;
                    }
