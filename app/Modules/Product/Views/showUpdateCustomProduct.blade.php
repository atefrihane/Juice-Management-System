                    ...
                    {{csrf_field()}}
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{$companyPrice->product->barcode}}"  type="text"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{$companyPrice->product->public_price}}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="disabledInput" name="price" value="{{$companyPrice->price}}" type="number"
