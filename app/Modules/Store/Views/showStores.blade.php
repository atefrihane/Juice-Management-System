                        ...
                        <div class="scrollable-table">
                                ...
                                <table class="table table-bordered table-hover example2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="table-tr">
                                                @if($store->photo)
                                                <td data-url="{{route('showStore',['company_id'=>$company->id,'store_id'=>$store->id])}}"
                                                    style="width:150px;"> <img src="{{ asset('img/'.$store->photo) }}" height="80"
                                                        class="user-image" alt="User Image"> </td>
                                                @else
                                                <td data-url="{{route('showStore',['company_id'=>$company->id,'store_id'=>$store->id])}}"
                                                    style="width:150px;"> <img src="{{asset('/img')}}/no-logo.png" height="80"
                                                        class="user-image" alt="User Image"> </td>
                                                @endif
                                                <td
                                                    data-url="{{route('showStoreRentals',['company_id'=>$company->id,'store_id'=>$store->id])}}">
                                                    {{$store->code}}</td>
                                                <td
                                                    data-url="{{route('showStoreRentals',['company_id'=>$company->id,'store_id'=>$store->id])}}">
                                                ...
                                                <td class="not-this text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu edit" role="menu">
                                                            <li><a
                                                                    href="{{route('showStore',['company_id'=>$company->id,'store_id'=>$store->id])}}">Voir
                                                                    détails</a></li>
                                                            @if(Auth::user()->primaryAdmin())
