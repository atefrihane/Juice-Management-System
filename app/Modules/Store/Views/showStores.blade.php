                    ...
                    <div class="box-body">
                        <table class="table table-bordered table-hover example2">
                            ...
                            <tbody>
                                ...
                                <tr class="table-tr">
                                @if($store->photo)
                    <td data-url="{{route('showStore',['company_id'=>$company->id,'store_id'=>$store->id])}}" style="width:150px;">    <img src="{{ asset('img/'.$store->photo) }}" height="80" class="user-image" alt="User Image"> </td>
                    @else
