                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="not-this text-center">
                                    ...
                                    <ul class="dropdown-menu edit" role="menu">
                                        <li><a
                                                href="{{route('showEditProductQuantity',$warehouseProduct->pivot->id)}}">       <span class="dropdown-font">Modifier </span></a>
                                        </li>
                                        <li><a href="#" data-toggle="modal"
                                                data-target="#modal-default{{$warehouseProduct->id}}">  <span class="dropdown-font">Supprimer</span></a>
                                        </li>
