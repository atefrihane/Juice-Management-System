    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                            ...
                            <table class="table table-bordered table-hover example2">
                                ...
                                <tbody>
                                    ...
                                    <tr @if($order->status >=2) class="table-tr" @endif>
                                        ...
                                        <td data-url="{{route('showOrder',$order->id)}}">{{$order->store->designation}}
                                        </td>
                                        <td data-url="{{route('showOrder',$order->id)}}">
                                            {{$order->store->zipcode->code}}
                                        </td>
                                        <td data-url="{{route('showOrder',$order->id)}}">
                                            @convert($order->totalOrdered()->sum)</td>
                                        ...
                                        <td>
                                            ...
                                            <ul class="dropdown-menu edit" role="menu">
                                                @if(Auth::user()->preparatorAdmin())
                                                <li><a href="{{route('showUpdateOrder',$order->id)}}"> <span
                                                            class="dropdown-font">Modifier</span></a></li>
                                                <li><a data-toggle="modal" data-target="#modal-default{{$order->id}}">
                                                        <span class="dropdown-font">Supprimer</span></a></li>
                                                @endif
                                            </ul>
                        ...
                        <td>
                            ...
                            <ul class="dropdown-menu edit" role="menu">
                                ...
                                <li><a href="{{route('showUpdateOrder',$order->id)}}"> <span
                                            class="dropdown-font">Modifier</span></a></li>
                                <li><a data-toggle="modal" data-target="#modal-default{{$order->id}}"> <span
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-block btn-primary style-button-dropdown"
                            ...
                            <span class="style-dropdown">Plus</span></button>
                        <ul class="dropdown-menu edit" role="menu">
                            <li><a href="{{route('showOrder',$order->id)}}"> <span class="dropdown-font">Voir
                                        détails</span></a></li>
                            @if(Auth::user()->preparatorAdmin())
                            <li><a href="{{route('showUpdateStatusOrder',$order->id)}}"> <span
                                        class="dropdown-font">Mettre à jour état</span></a></li>
                            @endif
                        </ul>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-block btn-primary style-button-dropdown" data-toggle="dropdown"
                    ...
                    <ul class="dropdown-menu edit" role="menu">
                        <li><a href="{{route('showOrder',$order->id)}}"> <span class="dropdown-font">Voir
                                    détails</span></a></li>
                        @if(Auth::user()->preparatorAdmin())
                        <li><a href="{{route('showOrderPreparedProducts',$order->id)}}"">   <span class="
                                dropdown-font">Modifier la préparation</span></a></li>
                        <li><a href="
                                    {{route('showUpdateStatusOrder',$order->id)}}"> <span class="dropdown-font">Mettre
                                    à jour état</span></a></li>
                        @endif
                    </ul>
            ...
            <td>
                ...
                <button type="button" class="btn btn-block btn-primary style-button-dropdown" data-toggle="dropdown"
                    ...
                    <span class="style-dropdown">Plus</span></button>
                <ul class="dropdown-menu edit" role="menu">
                    <li><a href="{{route('showOrder',$order->id)}}"> <span class="dropdown-font">Voir détails</span></a>
                    </li>
                    @if(Auth::user()->preparatorAdmin())
                    <li><a href="{{route('showOrderPreparedProducts',$order->id)}}"">   <span class="
                            dropdown-font">Modifier la préparation</span></a></li>
                    <li><a href=" {{route('showUpdateDeliveryOrder',$order->id)}}"">   <span class="
                            dropdown-font">Modifier la livraison</span></a>
                    </li>
                    <li><a href=" {{route('showUpdateStatusOrder',$order->id)}}"> <span class="dropdown-font">Mettre à
                                jour état</span></a></li>
                    @endif
                </ul>
        ...
        <td>
            ...
            <button type="button" class="btn btn-block btn-primary style-button-dropdown" data-toggle="dropdown"
                ...
                <span class="style-dropdown">Plus</span></button>
            <ul class="dropdown-menu edit" role="menu">
                <li><a href="{{route('showOrder',$order->id)}}"><span class="dropdown-font">Voir détails</span></a></li>
                @if(Auth::user()->preparatorAdmin())
                <li><a href="{{route('showOrderPreparedProducts',$order->id)}}""><span class=" dropdown-font">Modifier
                        la préparation</span></a></li>
                <li><a href=" {{route('showUpdateDeliveryOrder',$order->id)}}""><span class=" dropdown-font">Modifier la
                        livraison</span></a></li>
                @endif
                @if(Auth::user()->preparatorAdmin() || $order->delivery_man_id == Auth::id() ||
                Auth::user()->mainDelivery())
                <li><a href=" {{route('showUpdateStatusOrder',$order->id)}}"><span class="dropdown-font">Mettre à jour
                            état</span></a></li>
                @endif
            </ul>
...
<td>
    ...
    <ul class="dropdown-menu edit" role="menu">
        <li><a href="{{route('showOrder',$order->id)}}"><span class=" dropdown-font">Voir détails</span></a></li>
        @if(Auth::user()->preparatorAdmin())
        <li><a href="{{route('showOrderPreparedProducts',$order->id)}}""><span class=" dropdown-font">Modifier la préparation</span></a></li>
                        <li><a href=" {{route('showUpdateDeliveryOrder',$order->id)}}""><span class=" dropdown-font">Modifier la livraison</span></a></li>
        @endif
        @if(Auth::user()->preparatorAdmin() || $order->delivery_man_id == Auth::id() ||
        Auth::user()->mainDelivery())
        <li><a href=" {{route('showUpdateStatusOrder',$order->id)}}"><span class=" dropdown-font">Mettre à jour état</span></a></li>
        @endif
    </ul>
...
<td>
        ...
        <ul class="dropdown-menu edit" role="menu">
            <li><a href="{{route('showOrder',$order->id)}}"><span class=" dropdown-font">Voir détails</span></a></li>
            @if(Auth::user()->preparatorAdmin())
            <li> <a data-toggle="modal" data-target="#modal-default{{$order->id}}"><span class=" dropdown-font">Archiver</span></a></li>
            @endif
        </ul>
...
<td >
        ...
        <ul class="dropdown-menu edit" role="menu">
            <li><a href="{{route('showOrder',$order->id)}}"><span class=" dropdown-font">Voir détails</span></a></li>
            @if(Auth::user()->preparatorAdmin())
            <li><a data-toggle="modal" data-target="#modal-default{{$order->id}}"><span class=" dropdown-font">Supprimer</span></a></li>
            @endif
        </ul>
...
<tr>
    <td colspan="9" class="text-center">
        <h4> Aucune commande existante !</h4>
    </td>
</tr>
