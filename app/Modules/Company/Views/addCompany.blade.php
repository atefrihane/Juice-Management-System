                    ...
                    <form role="form" action="{{route('handleAddCompany')}}" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="name" id="exampleInputPassword1"
                                    placeholder="Nom du groupe" value="{{old('name')}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Désignation</label>
                                <input required type="text" class="form-control" name="designation"
                                    id="exampleInputPassword1" placeholder="Désignation" value="{{old('designation')}}">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" name="zip_code" class="form-control"
                                            id="exampleInputPassword1" placeholder="Code Postal"
                                            value="{{old('zip_code')}}">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="complement" class="form-control" id="exampleInputPassword1"
                                    placeholder="Complement addresse" value="{{old('complement')}}">
                            </div>
                            <div class="form-group">
